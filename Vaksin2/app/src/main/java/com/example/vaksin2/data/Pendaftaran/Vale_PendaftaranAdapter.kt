...
class Vale_PendaftaranAdapter(private val pendaftaranList: ArrayList<Vale_Pendaftaran>) :
    RecyclerView.Adapter<Vale_PendaftaranAdapter.PendaftarViewHolder>(){
    ...
    override fun onBindViewHolder(holder: PendaftarViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            activity.startActivity(Intent(activity, Vale_EditPendaftaranActivity::class.java).apply {
