...
import com.example.vaksin2.Vale_PendaftaranActivity
import com.example.vaksin2.data.Vale_VaksinDatabase
import com.example.vaksin2.databinding.ActivityValeEditPendaftaranBinding
import kotlinx.coroutines.launch
import java.io.File
import java.io.FileOutputStream
import java.io.OutputStream

class Vale_EditPendaftaranActivity : AppCompatActivity() {
    private var _binding: ActivityValeEditPendaftaranBinding? = null
    ...
    lateinit var pendaftarDB: Vale_VaksinDatabase
    ...
    private fun editPendaftar() {
        ...
        lifecycleScope.launch {
            val pendaftar = Vale_Pendaftaran(nik_pendaftar, nama_pendaftar, umur_pendaftar, jenis_kelamin_pendaftar, penyakit_bawaan_pendaftar, foto_final_dir)
            pendaftar.id = id_pendaftar
            pendaftarDB.getPendaftaranDao().updatePendaftaran(pendaftar)
        }
        val intentPendaftar = Intent(this, Vale_PendaftaranActivity::class.java)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        _binding = ActivityValeEditPendaftaranBinding.inflate(layoutInflater)
        setContentView(binding.root)

        pendaftarDB = Vale_VaksinDatabase(this@Vale_EditPendaftaranActivity)
